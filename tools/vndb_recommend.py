...
from _vndb_common import execute_action, info_from_definition, recommend_definition


def definition(ctx: dict[str, Any]) -> dict[str, Any]:
    return recommend_definition()
...
async def execute(args: dict[str, Any], runtime: dict[str, Any], ctx: dict[str, Any]) -> dict[str, Any]:
    return await execute_action("recommend", args, runtime, ctx)
